...
namespace Finance.ViewModelComposition
{
    class ReviewReservedTicketsLoadedSubscriber : ICompositionEventsSubscriber
    {
        ...
        public ReviewReservedTicketsLoadedSubscriber() : this(FinanceContextFactory.Create())
        {
        }

        internal ReviewReservedTicketsLoadedSubscriber(Func<Data.FinanceContext> contextFactory)
        {
